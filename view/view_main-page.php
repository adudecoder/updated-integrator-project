...
<body class="bg-light" data-bs-spy="scroll" data-bs-target="#menu">
  <div class="container">
    ...
    <!-- <div class="p-4 p-md-5 mb-4 rounded text-bg-warning">
      <div class="col-md-6 px-0">
        <h1 class="display-4 fst-italic">Chegou Moto Rápido.</h1>
        <img src="//d9hhrg4mnvzow.cloudfront.net/99app.com/99-moto/629556c3-img-1_10kd0ga0ix0fv00f00f028.png" class="card-img-top" alt="...">
        <p class="lead my-3">Agora você pode solicitar viagens de moto no app da Moto Rápido para ir e voltar de qualquer lugar. Exclusiva para corridas de passageiros.</p>
        <p class="lead mb-0"><a href="#" class="text-white fw-bold">Continue reading...</a></p>
      </div>
    </div> -->

    <div class="container col-xxl-8 px-4 py-5 bg-warning">
      <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
        <div class="col-10 col-sm-8 col-lg-6 bg-white rounded-2">
          <img src="//d9hhrg4mnvzow.cloudfront.net/99app.com/99-moto/629556c3-img-1_10kd0ga0ix0fv00f00f028.png" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" loading="lazy" width="700" height="500">
        </div>
        <div class="col-lg-6">
          <h1 class="display-5 fw-bold lh-1 mb-3">Chegou Moto Rápido.</h1>
          <p class="lead">Agora você pode solicitar viagens de moto no app da Moto Rápido para ir e voltar de qualquer lugar. Exclusiva para corridas de passageiros.</p>
    ...
    <div class="container col-xxl-8 px-5 bg-warning">
      <div class="row pt-5 mt-3">
        <div class="col-12">
          <h2 class="display-5 fw-bold">Conta com Moto Rápido e conheça as vantagens da categoria:</h2>
        </div>
      </div>
      <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
        <div class="list-group w-auto">
          <div class="list-group-item d-flex gap-3 py-3" aria-current="true">
            <img src="//d9hhrg4mnvzow.cloudfront.net/99app.com/99-moto/56ddf51b-icon-02_102e02f02e02e000000028.png" alt="twbs" class="rounded-circle flex-shrink-0" width="32" height="32">
          ...
          <div class="list-group-item d-flex gap-3 py-3" aria-current="true">
            <img src="//d9hhrg4mnvzow.cloudfront.net/99app.com/99-moto/c48faa57-icon-relogio-prancheta-1_103u02r000000000000028.png" alt="twbs" class="rounded-circle flex-shrink-0" width="32" height="32">
            <div class="d-flex gap-2 w-100 justify-content-between">
              <div>
                <h6 class="mb-0">Praticidade</h6>
                <p class="mb-0 opacity-75">Chegue em menos tempo ao encurtar o seu destino e ainda evite o trânsito intenso da cidade.</p>
              </div>
            </div>
          </div>
          <div class="list-group-item d-flex gap-3 py-3" aria-current="true">
            <img src="//d9hhrg4mnvzow.cloudfront.net/99app.com/99-moto/fb4c5386-lp-icon-06_102o02o02o02n000000028.png" alt="twbs" class="rounded-circle flex-shrink-0" width="32" height="32">
            <div class="d-flex gap-2 w-100 justify-content-between">
              <div>
        ...
        <!-- <div class="col-lg-6 bg-white rounded-3">
          <div class="container">
            <h5 class="display-5 fw-bold lh-1 mb-3">Economia</h5>
            <p class="lead">Economize ainda mais no seu dia a dia</p>
          </div>
          <div class="container">
            <h3 class="display-5 fw-bold lh-1 mb-3">Praticidade</h3>
            <p class="lead">Chegue em menos tempo ao encurtar o seu destino e ainda evite o trânsito intenso da cidade</p>
          </div>
          <div class="container">
            <h3 class="display-5 fw-bold lh-1 mb-3">Segurança</h3>
            <p class="lead">Conte com o recursos de segurança da 99. Passageiros e passageiras, assim como motociclistas parceiros e parceiras têm direito ao seguro de proteção contra acidentes.</p>
          </div>
        </div> -->
      </div>
    </div>
